...
export default function ChildArticle() {
    return (
        <div className="latest-news__card">
            <article className="article-item">
                <div className="article-item__thumbnail">
                    <Link to="/">
                        <img src="/images/blog-1.jpg" alt="/img/blog-1.jpg" />
                    </Link>
                </div>
                <div className="article-item__content">
                    <h2 className="article-item__title">
                    <Link to="/only-someone-who's-seen-the-mummy-will-pass-this/">Only Someone Who's Seen The Mummy Will
                        Pass This</Link>
                    </h2>
